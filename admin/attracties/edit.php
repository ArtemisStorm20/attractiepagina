    ...
    <div class="container">
        ...
        <form action="../backend/ridesController.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-input" rows="4"><?php echo htmlspecialchars($ride['description']); ?></textarea>
            </div>
            <div class="form-group">
                <label for="min_length">Minimale lengte (cm):</label>
                <input type="number" name="min_length" id="min_length" class="form-input" min="0" value="<?php echo htmlspecialchars($ride['min_length']); ?>">
            </div>
            <div class="form-group">
